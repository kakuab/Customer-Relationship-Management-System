...
<script type="text/javascript">
	...
	$(function(){
		...
		//给解除按钮添加单击事件
		$("#fulshTbody").on("click","a",function () {
			//封装参数
			var activityId=$(this).attr("activityId");
			var clueId="${clue.id}";
			//发送请求
			$.ajax({
				url:"workbench/clue/relieveActivityClueRelation.do",
				data:{
		...
		<c:forEach items="${clueRemarkList}" var="remark">
			<div class="remarkDiv" id="div_${remark.id}" style="height: 60px;">
				...
				<div style="position: relative; top: -40px; left: 40px;" >
					...
					<font color="gray">${clue.source}</font> <font color="gray">-</font> <b>${clue.fullname}${clue.appellation}-${clue.company}</b> <small style="color: gray;"> ${remark.editFlag=="0"?remark.createTime:remark.editTime} 由${remark.editFlag=="0"?remark.createBy:remark.editBy}${remark.editFlag=="0"?"创建":"修改"}</small>
