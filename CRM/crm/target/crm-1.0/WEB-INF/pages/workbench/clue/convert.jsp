...
<script type="text/javascript">
	$(function(){
		...
		$("#searchActivity").keyup(function () {
			...
			//发送ajax请求
			$.ajax({
				url:"workbench/clue/selectActivityForDetailByNameClueIdIn.do",
				data:{
		...
		$("#saveConvertClue").click(function () {
			...
			alert(isCreateTran+1111)
			//发起请求
			$.ajax({
				url:"workbench/clue/converClueChange.do",
				data:{
					clueId:clueId,
					money:money,
					name:name,
...
<body>
		...
		<form>
		  ...
		  <div class="form-group" style="width: 400px;position: relative; left: 20px;">
		    ...
		    <select id="stage"  class="form-control">
				<c:forEach items="${dicValueList}" var="list">
					<option id="${list.id}">${list.value}</option>
				</c:forEach>
		    	<%--<option></option>
		    	<option>资质审查</option>
		    	<option>需求分析</option>
	...
	<div id="operation" style="position: relative; left: 40px; height: 35px; top: 100px;">
		...
		&nbsp;&nbsp;&nbsp;&nbsp;
		<input class="btn btn-default" type="button" value="取消" id="quxiao">
	</div>
</body>
</html>