	...
	$(function () {
		...
		$("#create-customerName").typeahead({
			source:function (jquery,process) {
				$.ajax({
					url:"workbench/transaction/selectCusntomerName.do",
					data:{
						customerName:jquery
					},
					type:"post",
...
<body>
	...
	<form class="form-horizontal" role="form" style="position: relative; top: -30px;">
		...
		<div class="form-group">
			...
			<div class="col-sm-10" style="width: 300px;">
				<input type="hidden" id="create-activityId" value="630c47ac07124dcb91810aefbf7eefd3">
				<input type="text" class="form-control" id="create-activityName" value="测试104546">
			</div>
		</div>
		...
		<div class="form-group">
			...
			<div class="col-sm-10" style="width: 300px;">
				<input type="hidden" id="create-contactsId" value="573859ffaaae43768b093ddfe9d1ac67">
				<input type="text" class="form-control" id="create-contactsName" value="赵六">
			</div>
		</div>
