			...
			<div style="position: relative;top: 10px;">
				<table class="table table-hover">
					...
					<c:forEach items="${tranList}" var="tran">
						<tr>
							<td><input type="checkbox" id="tran_${tran.id}" value="${tran.id}"/></td>
							<td><a style="text-decoration: none; cursor: pointer;" onclick="window.location.href='workbench/transaction/toDetailTran.do?id=${tran.id}';">${tran.name}</a></td>
							<td>${tran.name}</td>
							<td>${tran.stage}</td>
							<td>${tran.type}</td>
							<td>${tran.owner}</td>
