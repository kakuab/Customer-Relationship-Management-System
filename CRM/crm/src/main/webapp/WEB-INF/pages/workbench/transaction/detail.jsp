...
<body>
	...
	<div style="position: relative; top: 0px;">
		...
		<div style="position: relative; left: 40px; height: 30px; top: 10px;">
			...
			<div style="width: 300px;position: relative; left: 450px; top: -40px; color: gray;">预计成交时间</div>
		...
		<div style="position: relative; left: 40px; height: 30px; top: 30px;">
			...
			<div style="width: 300px;position: relative; left: 650px; top: -60px;"><b>${tran.possiblity}</b></div>
			<div style="height: 1px; width: 400px; background: #D5D5D5; position: relative; top: -60px;"></div>
			<div style="height: 1px; width: 400px; background: #D5D5D5; position: relative; top: -60px; left: 450px;"></div>
		</div>
		...
		<c:forEach items="${tranRemarkList}" var="remark">
			<div class="remarkDiv" id="div_${remark.id}" style="height: 60px;">
				...
				<div style="position: relative; top: -40px; left: 40px;" >
					...
					<font color="gray">交易</font> <font color="gray">-</font> <b>${tran.name}</b> <small style="color: gray;"> ${tran.flag=='0'?remark.createTime:remark.editTime} 由${tran.flag=='0'?remark.createBy:remark.editBy}${tran.flag=='0'?'创建':'修改'}</small>
		...
		<div style="position: relative; top: 100px; left: 40px;">
			...
			<div style="position: relative;top: 0px;">
				<table id="activityTable" class="table table-hover" style="width: 900px;">
					...
					<tbody>
					<c:forEach items="${tranHistories}" var="his">
						<tr>
							<td>${his.stage}</td>
							<td>${his.money}</td>
							<td>${his.expectedDate}</td>
							<td>${his.createBy}</td>
